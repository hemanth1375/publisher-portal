...
const body= {
  ...
  "extra_config": {
    ...
    // },
    ...(this.upstreamThrottlingData?.isCircuitBreakerActive &&{"qos/circuit-breaker": {
    ...
    ...((this.upstreamResponseData?.regexConReplacerActive || this.upstreamPoliciesData?.isResSchValidatorActive) &&{"plugin/req-resp-modifier": {
      "name": [
   ...
   ...(this.upstreamThrottlingData?.isProxyRateLimitActive &&{"qos/ratelimit/proxy": {
    ...
    ...(this.upstreamResponseData?.isCachingActive &&{"qos/http-cache": {
      "shared": this.upstreamResponseData?.isSharedCacheActive
    }}),
    ...(this.upstreamAuthData?.isAuthActive &&{"auth/client-credentials": {
      "endpoint_params": {
        "5t": "ji"
      },
    ...
    ...(this.upstreamAuthData?.isGoogleCloudActive &&{"auth/gcp": {
      ...(this.upstreamAuthData?.audience &&{"audience": this.upstreamAuthData?.audience})
    }}),
    ...(this.upstreamAuthData?.isNtlmAuthActive &&{"auth/ntlm": {
      "user": "g",
      "password": "yu"
    }}),
    ...(this.upstreamPoliciesData?.isSecPolicyActive &&{"security/policies": {
      "req": {
    ...
    // }
    ...(this.upstreamConnectivityData?.isRestToGraphqlActive &&{"backend/graphql": {
  ...
  ...(this.upstreamConnectivityData?.restTographQLQueryPathForm &&{"query_path": this.upstreamConnectivityData?.restTographQLQueryPathForm}),
    ...
    ...(this.upstreamConnectivityData?.isRestToSoapActive &&{"backend/soap": {
      "@comment": null,
      "template": "",
  ...
  "debug": this.upstreamConnectivityData?.enableDebugRestToSoap,
    ...
    ...(this.upstreamConnectivityData?.isrestToGRPCActive &&{"backend/grpc": {
      ...(this.upstreamConnectivityData?.objectMapValue &&{"input_mapping": inputMapObj}),
      ...(this.upstreamConnectivityData?.restTogrpcResNamingConventionForm &&{"response_naming_convention": this.upstreamConnectivityData?.restTogrpcResNamingConventionForm}),
      ...(this.upstreamConnectivityData?.restTogrpcEnumsAsStrgsForm &&{"output_enum_as_string": this.upstreamConnectivityData?.restTogrpcEnumsAsStrgsForm}),
      ...(this.upstreamConnectivityData?.restTogrpcTimestmpAsStrgsForm &&{"output_timestamp_as_string": this.upstreamConnectivityData?.restTogrpcTimestmpAsStrgsForm}),
      ...(this.upstreamConnectivityData?.restTogrpcDurationAsStrgsForm &&{"output_duration_as_string": this.upstreamConnectivityData?.restTogrpcDurationAsStrgsForm}),
      // "client_tls": {
      //   "allow_insecure_connections": true
      // },
      ...(this.upstreamConnectivityData?.restTogrpcRemoveUnsetValForm &&{"output_remove_unset_values": this.upstreamConnectivityData?.restTogrpcRemoveUnsetValForm}),
      ...(this.upstreamConnectivityData?.restTogrpcUseReqBodyForm &&{"use_request_body": this.upstreamConnectivityData?.restTogrpcUseReqBodyForm})
    }}),
    ...(this.upstreamConnectivityData?.isHttpClientSettingActive &&{"backend/http/client": {
  ...
  "no_redirect": this.upstreamConnectivityData?.donotFollowRedirectsForm
    ...
    ...(this.upstreamRequestData?.isStaticServerActive &&{"backend/static-filesystem": {
      "directory_listing": this.upstreamRequestData?.directory_Listing,
...
...(this.upstreamResponseData?.AdvResManipulationActive &&{"modifier/jmespath": {
  "expr": this.upstreamResponseData?.expression
}}),
...(this.upstreamResponseData?.resManiWithGoTemplActive &&{"modifier/response-body-generator": {
